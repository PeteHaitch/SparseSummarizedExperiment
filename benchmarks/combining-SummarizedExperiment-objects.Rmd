...
```{r option-1-combine,SummarizedExperiment0,SummarizedExperiment0-method}
...
```{r option-2-combine,SummarizedExperiment0,SummarizedExperiment0-method}
setMethod("combine", c("SummarizedExperiment0", "SummarizedExperiment0"),
          function(x, y, ...) {
